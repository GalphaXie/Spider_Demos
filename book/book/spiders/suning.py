...
class SuningSpider(scrapy.Spider):
    name = 'suning'  # 爬虫名, 后续启动爬虫:　scrapy crawl suning
    allowed_domains = ['suning.com']  # 允许爬取范围
    start_urls = ['https://book.suning.com/']  # 可能需要手动修改,变成正确的 开始 url
